  ...
  return (
    <div className='md:w-[90%] mx-auto p-4 space-y-8'>
      ...
      <section className=''>
        ...
        <div>
          <p className='text-sm text-primary mt-1'>USD $ 3.5 - 4.5 LPA</p>
        </div>
        <div
          ...
          <Card className='' id='job-description'>
            ...
            <CardContent className=''>
              <p className='text-sm sm:text-base'>
                We are a diverse team and experienced team of developers driven
                by a passion for our art, united by our core values and inspired
                by a culture of inclusivity to build amazing games that thrill
                players everywhere. We pursue growth and innovation in an
                environment of safety and trust. Our culture is built on the
                belief that the more varied voices in our collective will
                strengthen our team and our games. We are looking for our next
                teammate who will raise our bar and make us better. What we
                need: As a Lead Environment Artist at 31st Union, your passion,
                knowledge, and experience will be integral to growing a team of
                talented artists and defining the look and style of a new
                generation of player driven experiences. Your expertise will be
                central to bringing our immersive landscapes, architecture,
                props, and natural environments to life. Who you are: You are an
                experienced Environment Artist with strong knowledge AAA games
                and have an attention to detail. You are proficient in both
                Substance Designer and Substance Painter with knowledge in
                developing workflows and leading a team of artist. You are on
                the lookout for next gen tools and practices that empower your
                team and improve efficiency for the project. You possess a keen
                ability to communicate and collaborate across disciplines
                sharing ideas and articulating visions. You are inspired by
                growth and excellence and thrive on sharing your knowledge with
                your teammates while continually honing your craft. Iterating,
                communicating, and creating together is what drives your passion
                for art and games. You are knowledgeable in all the tools,
                techniques, and asset creation pipelines: UE5, Substance
