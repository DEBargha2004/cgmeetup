  ...
  return (
    <main className='h-full max-w-[100vw] flex justify-between items-start'>
      ...
      >
        ...
        hover:bg-lightAccent/45 transition-all cursor-pointer'
          >
      ...
      <div className='w-[30%] h-full overflow-y-auto  px-4 scroller space-y-6'>
        ...
        <section id='comments' className='space-y-2'>
          <p className='sticky top-0 bg-background z-10 py-2 font-semibold'>
            Comments (2)
          </p>
          <Separator />
