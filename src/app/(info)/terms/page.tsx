...
export default function TermsPage () {
  return (
    <MainContainer>
      <Header className='text-center'>Terms & Condition</Header>
      <ArticleContainer>
        <ol className='list-decimal space-y-4 [&>li]:space-y-2'>
          <li>
            <ListHeader>
              Respect other people using the site and keep the law.
            </ListHeader>
            <Paragraph>
              CGMEETUP provides its service to you subject to the following
              terms and conditions (the "Terms of Service"). CGMEETUP may also
              offer other services that are governed separately by their own
              Terms of Service.
            </Paragraph>
          </li>
          <li>
            ...
            <Paragraph>
              CGMEETUP provides a collection of content, resources, tools, and
              technologies that enable users to enjoy computer graphics and its
              surrounding culture (the “Service”). You understand and agree that
              the Service is provided “AS-IS” and that CGMEETUP does not assume
              any liability for personal information stored through our Service.
              You accept that the Service may include advertisements. CGMEETUP
              ...
              thereof) with or without notice. You agree that CGMEETUP shall not
              be liable to you or to any third party for any modification,
              suspension or discontinuance of the Service.
            </Paragraph>
          </li>
          <li>
            <ListHeader>Registration</ListHeader>
            <Paragraph>
              In consideration of your use of the Service, you represent that
              you are of legal age to form a binding contract. You also agree
              to: (a) provide true, accurate, current and complete information
              about yourself as prompted by the Service's registration form and
              ...
              or if CGMEETUP has reasonable grounds to suspect that such
              information is untrue, inaccurate, not current or incomplete,
              CGMEETUP has the right to suspend or terminate your account and
              refuse any and all current or future use of the Service. CGMEETUP
              is concerned about the safety and privacy of all its users,
              particularly children. For this reason, parents or guardians of
              children under the age of 13 who wish to allow their children
              access to the Service must create an account that is maintained by
              a legal guardian of at least 18 years old and monitor the child's
              usage. By allowing a child access to your account, you also give
              your child permission to access all areas of the Service. Please
              remember that the Service is designed to appeal to a broad
              audience. Accordingly, as the legal guardian, it is your
              responsibility to determine whether any of the Service areas
              and/or Content are appropriate for your child.
            </Paragraph>
          </li>
          <li>
            <ListHeader>Member Accounts</ListHeader>
            <Paragraph>
              While many portions of the Service do not require registration,
              you may register as a user of CGMEETUP to enjoy greater access or
              privileges. If you choose to register you will receive a username
              and password upon completing the Service's registration process.
              ...
              immediately notify CGMEETUP of any unauthorized use of your
              password or account or any other breach of security, and (b)
              ensure that you exit from your account at the end of each session.
              CGMEETUP cannot and will not be liable for any loss or damage
              arising from your failure to protect your account. You
              acknowledge, consent and agree that CGMEETUP may access, preserve
              ...
              with legal process; (b) enforce the TOS; (c) respond to claims
              that any Content violates the rights of third parties; (d) respond
              to your requests for customer service; or (e) protect the rights,
              property or personal safety of CGMEETUP, its users and the public.
            </Paragraph>
          </li>
          <li>
            <ListHeader>Account Limitations</ListHeader>
            <Paragraph>
              You acknowledge that CGMEETUP may establish general practices and
              ...
              from or received by an account on the Service, the maximum size of
              any email message that may be sent from or received by an account
              on the Service, the maximum disk space that will be allotted on
              CGMEETUP’s servers on your behalf, and the maximum number of times
              (and the maximum duration for which) you may access the Service in
              a given period of time. You agree that CGMEETUP has no
              responsibility or liability for the deletion or failure to store
              any images, messages, and other communications or other Content
              maintained or transmitted by the Service. You acknowledge that
              CGMEETUP reserves the right to log off accounts that are inactive
              for an extended period of time. You further acknowledge that
              CGMEETUP reserves the right to modify these general practices and
              limits from time to time.
            </Paragraph>
          </li>
          <li>
            <ListHeader>Termination</ListHeader>
            <Paragraph>
              You agree that CGMEETUP may, under certain circumstances and
              without prior notice, immediately terminate your CGMEETUP account,
              any associated email address, and access to the Service. Cause for
              such termination shall include, but not be limited to, (a)
              breaches or violations of the TOS or other incorporated agreements
              ...
              problems, (f) extended periods of inactivity, (g) engagement by
              you in fraudulent or illegal activities, and/or (h) nonpayment of
              any fees owed by you in connection with the Services. Termination
              of your CGMEETUP account includes (a) removal of access to all
              offerings within the Service, (b) deletion of your password and
              all related information, files and content associated with or
              inside your account (or any part thereof), and (c) barring of
              further use of the Service. Further, you agree that all
              terminations for cause shall be made in CGMEETUP’s sole discretion
              and that CGMEETUP shall not be liable to you or any third party
              for any termination of your account, any associated email address,
              or access to the Service.
            </Paragraph>
          </li>
          <li>
            <ListHeader>Member Conduct</ListHeader>
            <div className='space-y-2'>
              <Paragraph>You agree to not use the Service to:</Paragraph>
              <ol className='list-upper-alpha pl-10 marker:text-sm marker:text-[rgba(255,255,255,0.7)]'>
                ...
                <li>
                  <Paragraph>Threaten or harm minors in any way;</Paragraph>
                </li>
                <li>
                  <Paragraph>"stalk" or otherwise harass another;</Paragraph>
                </li>
                <li>
                  <Paragraph>
                    impersonate any person or entity, including, but not limited
                    to, a CGMEETUP representative, or falsely state or otherwise
              ...
              <Paragraph>
                ...
                Service (including your CGMEETUP username), use of the Service,
                or access to the Service. You agree that your CGMEETUP account
                is non-transferable.
              </Paragraph>
            </div>
          </li>
          <li>
            ...
            <Paragraph>
              You understand that all information, images, data, text, software,
              ...
              such Content originated. This means that you, and not CGMEETUP,
              are entirely responsible for all Content that you upload, post,
              email, transmit or otherwise make available via the Service.
              CGMEETUP does not control the Content posted via the Service and,
              as such, does not guarantee the accuracy, integrity or quality of
              such Content. You understand that by using the Service, you may
              unintentionally be exposed to Content that is offensive, indecent
              or objectionable. Under no circumstances will CGMEETUP be liable
              ...
              You acknowledge that CGMEETUP may or may not pre-screen Content,
              but that CGMEETUP and its designees shall have the right (but not
              the obligation) in their sole discretion to pre-screen, refuse, or
              move any Content that is available via the Service. Without
              limiting the foregoing, CGMEETUP and its designees shall have the
              ...
              any Content created by CGMEETUP or submitted to CGMEETUP,
              including without limitation information in CGMEETUP forums and in
              all other parts of the Service. You understand that the Service
              and software embodied within the Service may include security
              components that permit digital materials to be protected, and that
              use of these materials is subject to usage rules set by CGMEETUP
              and/or content providers who provide content to the Service. You
              ...
              materials provided on the Service, in whole or in part, is
              strictly prohibited. CGMEETUP does not claim ownership of Content
              ...
              CGMEETUP the following worldwide, royalty-free and non-exclusive
              license: that any Content you submit or make available for
              ...
              perform and publicly display such Content (in whole or in part)
              and to incorporate such Content into other works in any format or
              medium now known or later developed.
            </Paragraph>
          </li>
          <li>
            <ListHeader>Indemnity</ListHeader>
            <Paragraph>
              You agree to indemnify and hold CGMEETUP and its subsidiaries,
          ...
          <li>
            <ListHeader>Dealings With Advertisers.</ListHeader>
            <Paragraph>
              ...
              advertiser. You agree that CGMEETUP shall not be responsible or
          ...
          <li>
            ...
            <Paragraph>
              ...
              other World Wide Web sites or resources. Because CGMEETUP has no
              control over such sites and resources, you acknowledge and agree
              that CGMEETUP is not responsible for the availability of such
              ...
              further acknowledge and agree that CGMEETUP shall not be
          ...
          <li>
            <ListHeader>Proprietary Rights</ListHeader>
            <Paragraph>
              ...
              or by advertisers is protected by copyrights, trademarks, service
              marks, patents or other proprietary rights and laws. Except as
              expressly authorized by CGMEETUP or advertisers, you agree not to
              ...
              CGMEETUP grants you a personal, non-transferable and non-exclusive
              ...
              third party to) copy, modify, create a derivative work from,
              ...
              form, nor to use modified versions of the Software, including
              ...
              CGMEETUP for use in accessing the Service.
            </Paragraph>
          </li>
          <li>
            <ListHeader>Trademark Information</ListHeader>
            <Paragraph>
              All CGMEETUP trademarks and service marks and other CGMEETUP logos
              and product and service names are trademarks of Full Spectrum
              Digital, LLC. Without CGMEETUP's prior permission, you agree not
              to display or use these trademarks in any manner.
            </Paragraph>
          </li>
          <li>
            <ListHeader>General Information</ListHeader>
            <Paragraph>
              The Terms of Service constitutes the entire agreement between you
              and CGMEETUP and governs your use of the Service, superseding any
              prior agreements between you and CGMEETUP with respect to the
              Service. You also may be subject to additional terms and
              conditions that may apply when you use or purchase certain other
              CGMEETUP services, affiliate services, third-party content or
              third-party software. The TOS and the relationship between you and
              CGMEETUP shall be governed by the laws of the State of California
              without regard to its conflict of law provisions. You and CGMEETUP
              agree to submit to the personal and exclusive jurisdiction of the
              courts located within the State of California. The failure of
              CGMEETUP to exercise or enforce any right or provision of the TOS
          ...
          <li>
            <ListHeader>DISCLAIMER OF WARRANTIES</ListHeader>
            <div className='space-y-2'>
              <Paragraph className=''>
              ...
              <ol className='list-upper-alpha pl-10 marker:text-sm marker:text-[rgba(255,255,255,0.7)]'>
                <li>
                  <Paragraph>
                    ...
                    PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. CGMEETUP
                ...
                <li>
                  <Paragraph>
                    CGMEETUP AND ITS SUBSIDIARIES, AFFILIATES, OFFICERS,
                    EMPLOYEES, AGENTS, PARTNERS AND LICENSORS MAKE NO WARRANTY
                ...
                <li>
                  <Paragraph>
                    ANY MATERIAL DOWNLOADED OR OTHERWISEComming Soon..!!
                ...
                <li>
                  <Paragraph>
                    ...
                    BY YOU FROM CGMEETUP OR THROUGH OR FROM THE SERVICE SHALL
                ...
                <li>
                  <Paragraph>
                    ...
                    EPILEPTIC SYMPTOMS EVEN IN USERS WHO HAVE NO HISTORY OF
                    PRIOR SEIZURES OR EPILEPSY. IF YOU, OR ANYONE IN YOUR
                    FAMILY, HAVE AN EPILEPTIC CONDITION, CONSULT YOUR PHYSICIAN
                    PRIOR TO USING THE SERVICE. IMMEDIATELY DISCONTINUE USE OF
                    THE SERVICE AND CONSULT YOUR PHYSICIAN IF YOU EXPERIENCE ANY
                    OF THE FOLLOWING SYMPTOMS WHILE USING THE SERVICE:
          ...
          <li>
            <ListHeader>LIMITATION OF LIABILITY</ListHeader>
            <Paragraph>
              OU EXPRESSLY UNDERSTAND AND AGREE THAT CGMEETUP AND ITS
              ...
              GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES (EVEN IF CGMEETUP
          ...
          <li>
            <ListHeader>EXCLUSIONS AND LIMITATIONS</ListHeader>
            <Paragraph>
