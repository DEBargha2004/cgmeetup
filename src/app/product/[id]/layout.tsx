...
import { AddFriend, ProfileInfoOverView, Tabs } from "@/components/custom";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
import "./style.css";
import ProductInfoTabs from "./_components/product-info-tabs";
  ...
  return (
    <main className="flex justify-center items-start pb-10 px-2">
      ...
      >
        ...
        <div>
          <h1 className="text-2xl">Xpeng X2 Flying car EVTOL 3D model</h1>
        </div>
