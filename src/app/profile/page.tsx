  ...
  return (
    <section className='h-full'>
      <div className='h-2/5 relative'>
        ...
        />
        <Avatar className='md:h-[200px] md:w-[200px] h-[150px] w-[150px] border-2 border-white absolute left-1/2 top-full -translate-x-1/2 -translate-y-1/2'>
          <AvatarImage
      ...
      <div className='mt-[150px] flex flex-col justify-between items-center gap-2'>
        <h1 className='md:text-4xl text-2xl font-bold'>Alibaba Salmon</h1>
        <p className='text-sm md:text-base opacity-60'>3D Animator</p>
        <p className='flex justify-center items-end opacity-60 text-sm md:text-base'>
          <MaterialSymbolIcon>location_on</MaterialSymbolIcon>&nbsp; Florida,USA
        </p>
        <div className='flex flex-col justify-between items-center gap-10 my-4 w-1/5 min-w-[250px]'>
          <div className='flex justify-between items-center gap-5 w-full'>
            <div className='text-center'>
              <h1 className='font-bold text-lg'>234</h1>
          ...
          <div className='flex gap-4 flex-wrap sm:flex-row justify-center'>
            <Button variant={'outline'} className='border-primary w-[150px]'>
              Follow
            </Button>
            <Button variant={'outline'} className='border-primary w-[150px]'>
              Message
      ...
      <div className='my-10'>
        <Tabs defaultValue='posts'>
          ...
          <TabsContent value='posts' className='w-full pb-20'>
            <ImageCollection />
          </TabsContent>
          <TabsContent value='jobs'>
            <section className='md:w-4/5 grid grid-cols-1 xl:grid-cols-2 gap-2 mx-auto px-2 pb-20'>
              {Array.from({ length: 4 }).map((_, i) => (
                <JobCard key={i} />
              ))}
            </section>
          </TabsContent>
          <TabsContent value='about' className='md:w-4/5 px-2 mx-auto'>
            <section className='md:w-3/5 mx-auto space-y-10 pb-20'>
